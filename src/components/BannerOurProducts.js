...
function BannerOurProducts() {
	return (
		<div id="product">
			<div className="content-containermy-20 sm:h-auto h-[100vh] flex items-center justify-center lg:flex-row flex-col xl:gap-16 md:gap-12 gap-10 ff-outfit xl:px-16 lg:px-10 sm:px-9 px-[24px]  xl:py-20 lg:py-16 md:py-10 py-12">
